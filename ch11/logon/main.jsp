                ...
                <tr>
                    ...
                    <tr>
                        <td colspan="3" bgcolor="<%=title_c%>" align="center">
                            ...
                            <input type="button" value="회원 가입" onclick="javascript:window.location='inputForm.jsp'">
                        </td>
                    </tr>
                    </form>
                </tr>
                ...
                <tr>
                    ...
                    <td rowspan="3" bgcolor="<%=value_c%>" align="center">
                        ...
                        <form method="post" action="logout.jsp">
                            ...
                            <input type="button" value="회원 정보 변경" onclick="javascript:window.location='modify.jsp'">
                        </form>
                    </td>
                </tr>
                <tr>
